...
class ASTNodeTests extends JUnitSuite{
  ...
  @Test def bvLiteralNode(): Unit = {
    ...
    assertEquals(Types.BitVector64,bvLiteral.nodeType)
  ...
  @Test def bvAndNode: Unit = {
    ...
    assertEquals(Types.BitVector64, bvAndNode.nodeType)
    assertEquals(1, bvAndNode.height)
    assertEquals(3, bvAndNode.terms)
    assertEquals("(bv.and #x0000000000000017 #x0000000000000008)", bvAndNode.code)
  ...
  @Test def bvOrNode: Unit = {
    ...
    assertEquals(Types.BitVector64, bvOrNode.nodeType)
    assertEquals(1, bvOrNode.height)
    assertEquals(3, bvOrNode.terms)
    assertEquals("(bv.or #x0000000000000017 #x0000000000000008)", bvOrNode.code)
  ...
  @Test def bvXOrNode: Unit = {
    ...
    assertEquals(Types.BitVector64, bvXOrNode.nodeType)
    assertEquals(1, bvXOrNode.height)
    assertEquals(3, bvXOrNode.terms)
    assertEquals("(bv.xor #x0000000000000017 #x0000000000000008)", bvXOrNode.code)
  ...
  @Test def bvComplement: Unit = {
    ...
    assertEquals(Types.BitVector64, bvComplement.nodeType)
    assertEquals(1, bvComplement.height)
    assertEquals(2, bvComplement.terms)
    assertEquals("(bv.not #x0000000000000017)", bvComplement.code)
  ...
  @Test def bvShiftLeft: Unit = {
    ...
    assertEquals(Types.BitVector64, bvShlNode.nodeType)
    assertEquals(1, bvShlNode.height)
    assertEquals(3, bvShlNode.terms)
    assertEquals("(bv.shl #x0000000000000017 #x0000000000000008)", bvShlNode.code)
  ...
  @Test def bvAShiftRight: Unit = {
    ...
    assertEquals(Types.BitVector64, bvShrNode.nodeType)
    assertEquals(1, bvShrNode.height)
    assertEquals(3, bvShrNode.terms)
    assertEquals("(bv.ashr #x0000000000000002 #x0000000000000001)", bvShrNode.code)
  ...
  @Test def bvLShiftRight: Unit = {
    ...
    assertEquals(1, bvShrNode.height)
    assertEquals(3, bvShrNode.terms)
    assertEquals("(bv.lshr #x0000000000000002 #x0000000000000001)", bvShrNode.code)
    assertEquals(List(1),bvShrNode.values)
    assertEquals(List(0),bvShrNodeSigned.values)
    assertEquals(List(arg,one), bvShrNode.children)
  }
