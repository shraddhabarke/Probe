...
class StringConcat(val lhs: StringNode, val rhs: StringNode, var prior: Int = 0) extends BinaryOpNode[String] with StringNode {
...
class StringAt(val lhs: StringNode, val rhs: IntNode, var prior: Int = 0) extends BinaryOpNode[String] with StringNode {
  override def doOp(l: Any, r: Any): String = {
...
class IntAddition(val lhs: IntNode, val rhs: IntNode, var prior: Int = 0) extends BinaryOpNode[Int] with IntNode {
...
class IntSubtraction(val lhs: IntNode, val rhs: IntNode, var prior: Int = 0)extends BinaryOpNode[Int] with IntNode {
  override def doOp(l: Any, r: Any): Int = l.asInstanceOf[Int] - r.asInstanceOf[Int]
...
class IntLessThanEq(val lhs: IntNode, val rhs: IntNode, var prior: Int = 0) extends BinaryOpNode[Boolean] with BoolNode {
...
class IntEquals(val lhs: IntNode, val rhs: IntNode, var prior: Int = 0) extends BinaryOpNode[Boolean] with BoolNode {
  override def doOp(l: Any, r: Any): Boolean = l.asInstanceOf[Int] == r.asInstanceOf[Int]
...
class PrefixOf(val lhs: StringNode, val rhs: StringNode, var prior: Int = 0) extends BinaryOpNode[Boolean] with BoolNode {
...
class SuffixOf(val lhs: StringNode, val rhs: StringNode, var prior: Int = 0) extends BinaryOpNode[Boolean] with BoolNode {
...
class Contains(val lhs: StringNode, val rhs: StringNode, var prior: Int = 0) extends  BinaryOpNode[Boolean] with BoolNode {
